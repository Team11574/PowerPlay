...
public class GenericConstants {
    public static PIDCoefficients JUNCTION_DISTANCE_PID = new PIDCoefficients(-0.001, -0.002, -0.0005);
    public static PIDCoefficients FORWARD_DISTANCE_PID = new PIDCoefficients(0.08, 0, 0);

    public static double JUNCTION_PREFERRED_PIXEL_DISTANCE_CLOSE = 40;
    ...
    public static double JUNCTION_WIDTH_TO_DISTANCE_FACTOR = 800;
